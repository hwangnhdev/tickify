...
<div class="bg-gradient-to-b from-blue-900 to-blue-700 text-white w-64 p-6 flex flex-col">
  ...
  <nav class="flex-1">
    <ul>
      ...
      <li class="mb-4">
        <a class="sidebar-item flex items-center p-2 rounded" href="${pageContext.request.contextPath}/admin/revenue">
            <i class="sidebar-icon fas fa-chart-line mr-3"></i> Manage Revenue
        </a>
    </li>
    <li class="mb-4">
        <a class="sidebar-item flex items-center p-2 rounded" href="${pageContext.request.contextPath}/pages/adminPage/validateTicket.jsp">
