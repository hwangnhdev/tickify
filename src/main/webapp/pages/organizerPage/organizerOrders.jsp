  ...
  <div class="flex h-screen">
    ...
    <aside class="fixed inset-y-0 left-0 transform w-64 bg-gradient-to-b from-green-900 to-black p-4 text-white transition-transform duration-300 md:w-1/6 md:relative md:transform-none z-50">
      ...
      <nav class="space-y-4">
        ...
        <a class="flex items-center text-white bg-green-700 p-2 rounded" href="${pageContext.request.contextPath}/organizerOrders"><i class="fas fa-list mr-2"></i>Order List</a>
      </nav>
    </aside>
      ...
      <section class="flex-1 p-4 overflow-y-auto">
        ...
        <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between bg-gray-800 p-4 rounded-lg shadow-md">
          ...
          <form id="searchForm" action="${pageContext.request.contextPath}/organizerOrders" method="get" class="flex items-center space-x-4 mt-4 sm:mt-0">
            <input type="text" name="searchOrder" placeholder="Search by customer name" class="p-2 rounded bg-gray-700 text-white border border-gray-600 focus:ring-2 focus:ring-green-500" value="${param.searchOrder}"/>
