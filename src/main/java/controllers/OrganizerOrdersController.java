...
public class OrganizerOrdersController extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response)
                ...
                // Lấy organizerId từ session, nếu không có dùng giá trị mặc định (mặc dù ở
                // phiên bản mới không dùng để lọc)
                ...
                // Gọi các phương thức DAO đã được cập nhật để chỉ lọc theo eventId (không dùng
                // organizerId)
