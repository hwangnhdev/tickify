...
//
//            // Lưu vào SQL Server
//            try ( Connection conn = DriverManager.getConnection(CloudinaryConfig.DB_URL, CloudinaryConfig.DB_USER, CloudinaryConfig.DB_PASSWORD);  PreparedStatement pstmt = conn.prepareStatement(
