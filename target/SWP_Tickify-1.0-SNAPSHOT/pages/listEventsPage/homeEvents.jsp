...
<html>
    ...
    <body>
        ...
        <script>
            const prevButton = document.querySelector(".prev-btn-trend_events");
            const nextButton = document.querySelector(".next-btn-trend_events");
            const eventCardsContainer = document.querySelector(".event-cards-trend_events"); // Đúng phần cần cuộn
            const eventCards = document.querySelectorAll(".event-card-trend_events");
            let currentIndex = 0;
        ...
        <script>
            const prevButton = document.querySelector(".prev-btn-top_events");
            const nextButton = document.querySelector(".next-btn-top_events");
            const eventCardsContainer = document.querySelector(".event-cards-top_events"); // Đúng phần cần cuộn
            const eventCards = document.querySelectorAll(".event-card-top_events");
            let currentIndex = 0;
        ...
        <script>
            const prevButton = document.querySelector(".prev-btn-rec_events");
            const nextButton = document.querySelector(".next-btn-rec_events");
            const eventCardsContainer = document.querySelector(".event-cards-rec_events"); // Đúng phần cần cuộn
            const eventCards = document.querySelectorAll(".event-card-rec_events");
            let currentIndex = 0;
